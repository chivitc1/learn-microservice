		...
		JsonDeserializer<MultiplicationResultAttempt>
{
	 ...
	 * @param _jsonParser    Parsed used for reading JSON content
	 * @param _deserializationContext Context that can be used to access information about
	 *             this deserialization activity.
	 * @return Deserialized value
	 */
	@Override
	public MultiplicationResultAttempt deserialize(JsonParser _jsonParser,
			DeserializationContext _deserializationContext)
			throws IOException, JsonProcessingException
	{
		ObjectCodec oc = _jsonParser.getCodec();
		JsonNode node = oc.readTree(_jsonParser);
